...
export const Route = createFileRoute("/admin/settings")({
  head: () => ({ meta: [{ title: "Settings — KNA Admin" }] }),
  component: () => (
    <div className="space-y-6 max-w-3xl">
      ...
      <section className="space-y-4">
        ...
        <div><Label>Display name</Label><Input className="mt-1.5" defaultValue="Kenya News Agency Digital Archive" /></div>
        <div><Label>Support email</Label><Input className="mt-1.5" defaultValue="archive@kna.go.ke" /></div>
      </section>
      <section className="space-y-3">
        ...
        <div className="flex items-start justify-between gap-6 border border-border bg-paper-warm p-4">
          <div>
            <p className="font-medium">Show KNA — PREVIEW overlay</p>
            <p className="mt-1 text-sm text-muted-foreground">Applied to all catalogue thumbnails and detail previews.</p>
          </div>
